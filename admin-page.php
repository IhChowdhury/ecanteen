...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="images/favicon/ee.png" sizes="32x32">
  <!-- Favicons-->
        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img style="width: 129px;
height:55px ;
padding-bottom: 10px;" src="images/logooo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <div class="wrapper">
      ...
      <section id="content">
        ...
        <div class="container">
          ...
          ?>
          <img src="<?php echo $row['image']; ?>" ><?php echo "</div></td>";
...
<table>
          ...
          echo '<td><div class="input-field col s12 ">';
          echo '<input name="fileToUpload" id="fileToUpload" type="file" data-error=".errorTxt02"><div class="errorTxt02"></div></td>';
  ...
  <footer class="page-footer">
    <div class="footer-copyright">
      <div class="container">
        ...
        <span class="right"> Design and Developed by Group 6 <a class="grey-text text-lighten-4" href="#"><b>482</b>Students</a></span>
        </div>
    </div>
  </footer>
    <!-- END FOOTER -->
