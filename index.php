        ...
        <div class="navbar-fixed">
            <nav class="navbar-color">
                <div class="nav-wrapper">
                    <ul class="left">                      
                      <li><h1 class="logo-wrapper"><a href="index.php" class="brand-logo darken-1"><img class="text-center center-block" style="width: 129px;
height:55px ;
padding-bottom: 10px;"  src="images/logooo.png" alt="logo"></a> <span class="logo-text">Logo</span></h1></li>
                    </ul>
                    <ul class="right hide-on-med-and-down">                        
                        <li><img src="images/favicon/ee.png" class="img-responsive"><?php echo $balance;?>
                        </li>
                    </ul>					
                </div>
            </nav>
      ...
      <section id="content">
        ...
        <div class="container">
		  ...
		  <form class="formValidate" id="formValidate" method="post" action="place-order.php" novalidate="novalidate">
           ...
           echo '<td>';
          ?>
          <img src="<?php echo $row['image']; ?>" ><?php echo "</td>";
